...
if superusers.exists():
    for su in superusers:
        ...
        su.save()
        print('Reset password to admin1234 for existing superuser: ' + str(su.phone))
else:
    try:
...
"""
        ...
        command = f"""
        cat << 'EOF' > /root/Kurslar/reset_admin.py
{py_script}
EOF
        docker cp /root/Kurslar/reset_admin.py kurslarim_web:/app/reset_admin.py
        docker exec kurslarim_web python manage.py shell < /root/Kurslar/reset_admin.py
        """
