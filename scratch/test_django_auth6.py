...
"""
        ...
        command = f"""
        cat << 'EOF' > /root/Kurslar/test_auth6.py
{py_script}
EOF
        docker cp /root/Kurslar/test_auth6.py kurslarim_web:/app/test_auth6.py
        docker exec kurslarim_web python /app/test_auth6.py
        """
