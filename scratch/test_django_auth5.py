...
"""
        ...
        command = f"""
        cat << 'EOF' > /root/Kurslar/test_auth5.py
{py_script}
EOF
        docker cp /root/Kurslar/test_auth5.py kurslarim_web:/app/test_auth5.py
        docker exec kurslarim_web python manage.py shell -c "$(cat /root/Kurslar/test_auth5.py)"
        """
