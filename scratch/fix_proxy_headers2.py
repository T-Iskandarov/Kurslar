...
EOF
        ...
        grep -q "SECURE_PROXY_SSL_HEADER" /root/Kurslar/mening_loyiham/settings.py || echo "SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')" >> /root/Kurslar/mening_loyiham/settings.py
        
        # Restart Gunicorn container
