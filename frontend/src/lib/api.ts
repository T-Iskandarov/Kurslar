const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://api.kurslarim.uz/api/v1';
export const MEDIA_BASE_URL = process.env.NEXT_PUBLIC_MEDIA_URL || 'https://api.kurslarim.uz';
