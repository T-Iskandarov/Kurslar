      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Award size={18} />
              <span className="hidden sm:inline">Sertifikatni tekshirish</span>
            </Link>
            {user ? (
              <>
                <Link href={user.is_staff ? "/admin" : "/profile"} className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors hidden sm:flex">
